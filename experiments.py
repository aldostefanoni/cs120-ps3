...
# Done: Fill in prog1 with the first RAM program provided in the homework.
prog1 = [8, 
    ['assign', zero_id, 0],
    ['assign', one_id, 1], 
    ...
    # Done: lines 5-8 from pseudocode
    ['assign', result_id, 17],
...
# Done: Fill in prog2 with the second RAM program provided in the homework.
prog2 = [10, 
    ['assign', zero_id, 0],
    ['assign', one_id, 1], 
    ['assign', seventeen_id, 17], 
    ...
    ['-', counter_id, counter_id, one_id],
    # Done: lines 14-19 from pseudocode
    ['goto', zero_id, 8],
    ['*', result_id, result_id, seventeen_id],
    ['/', temp_id, result_id, W_id],
    ['*', temp_id, temp_id, W_id],
